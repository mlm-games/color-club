...
func _ready() -> void:
	...
	stroke_coloring_check.button_pressed = SettingsManager.I.color_strokes
	auto_color_check.button_pressed = SettingsManager.I.auto_color_strokes
	stroke_color_picker.color = SettingsManager.I.stroke_color
